...
if (!empty($_SESSION['user'])) 
{
    ...
    <?php if ($user_session['role'] == 'staff') : ?>
        <a href='?module=admin&controller=product'>
            <button class='login-modal' style='width:auto'><i class="fas fa-user-cog" style='font-size: 14px'></i>Nhân viên quản lý</button>
        </a>
    <?php endif; ?>
        ...
        <div class="row">
            ...
            <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                <div class="img-container">
                    <img src="./public/site/img/login-signup/loginn-pic.png" alt="Avatar" class="avatar">
                </div>
            </div>
            ...
            <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
                <div class="main-form-content">
                    ...
                    <input type="text" placeholder="Nhập Email" name="email" id="li-email" onkeyup="validateEmail(this)">
                    <small id="li-email-err"></small>


                    <label for="psw"></label>
                    <input type="password" placeholder="Nhập mật khẩu" name="password" id="li-psw" onkeyup="validateNotEmpty(this, 'Password')">
