...
class CartController extends BaseController
{
    ...
    public function add()
    {
        ...
        $this->success['add_to_cart'] = "Sản phẩm '" . $pro['name'] . "' đã thêm vào giỏ hàng thành công";
    ...
    public function addAjax()
    {
        ...
        $pro = $this->productModel->findProductById(['*'], $id);
        $this->cart->add($pro);
        $message = "Sản phẩm '" . $pro['name'] . "' đã thêm vào giỏ hàng thành công";
        $ajaxRes = array();
    ...
    public function addQuantity()
    {
        ...
        $this->success['add_to_cart_quantity'] = $quantity_add_more . ($quantity_add_more > 1 ? " products '" : " sản phẩm '") . $pro['name'] . "' đã thêm vào giỏ hàng thành công";
